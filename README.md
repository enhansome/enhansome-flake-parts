...
* [services flake](https://github.com/juspay/services-flake) ⭐ 762 | 🐛 56 | 🌐 Nix | 📅 2026-08-18 -  NixOS-like services for Nix as flake modules.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 603 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 4 | 🌐 Nix | 📅 2026-08-20 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 198 | 🐛 14 | 🌐 Nix | 📅 2026-08-21 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 1 | 🌐 Nix | 📅 2026-08-20 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
