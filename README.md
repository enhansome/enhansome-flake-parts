...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,456 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Source code and issue tracker.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,456 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,549 | 🐛 98 | 🌐 Nix | 📅 2026-06-18 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 946 | 🐛 21 | 🌐 Nix | 📅 2026-08-30 - Gaming tools and configurations.
...
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 642 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - Declarative formatter configuration.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 612 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
* [import-tree](https://github.com/vic/import-tree) ⭐ 326 | 🐛 4 | 🌐 Nix | 📅 2026-07-17 - Import all nix files in a directory tree.
* [flake-file](https://github.com/vic/flake-file) ⭐ 148 | 🐛 14 | 🌐 Nix | 📅 2026-07-28 - Dynamically generate your flake.nix from flake-parts modules.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 3 | 🌐 Nix | 📅 2026-08-29 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 201 | 🐛 14 | 🌐 Nix | 📅 2026-08-30 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,456 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Q\&A and discussions.
