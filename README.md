...
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 947 | 🐛 21 | 🌐 Nix | 📅 2026-08-30 - Gaming tools and configurations.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 615 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
* [import-tree](https://github.com/vic/import-tree) ⭐ 326 | 🐛 4 | 🌐 Nix | 📅 2026-07-17 - Import all nix files in a directory tree.
* [flake-file](https://github.com/vic/flake-file) ⭐ 149 | 🐛 14 | 🌐 Nix | 📅 2026-07-28 - Dynamically generate your flake.nix from flake-parts modules.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 3 | 🌐 Nix | 📅 2026-08-31 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 201 | 🐛 14 | 🌐 Nix | 📅 2026-08-31 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
* [dropol/infra](https://github.com/drupol/infra) ⭐ 153 | 🐛 2 | 🌐 Nix | 📅 2026-08-29 - Pol Dellaiera's configuration of all his home computers.
* [vic/vix](https://github.com/vic/vix) ⭐ 95 | 🐛 25 | 🌐 Nix | 📅 2026-04-28 - Vic's \*Nix config with flake-parts and [import-tree](https://github.com/vic/import-tree) ⭐ 326 | 🐛 4 | 🌐 Nix | 📅 2026-07-17.
...
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 0 | 🌐 Nix | 📅 2026-08-30 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
