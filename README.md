...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,449 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Source code and issue tracker.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,449 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,547 | 🐛 97 | 🌐 Nix | 📅 2026-06-18 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 943 | 🐛 22 | 🌐 Nix | 📅 2026-08-23 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 856 | 🐛 91 | 🌐 Nix | 📅 2026-08-22 - Git pre-commit hooks integration.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 4 | 🌐 Nix | 📅 2026-08-22 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 200 | 🐛 14 | 🌐 Nix | 📅 2026-08-23 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,449 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Q\&A and discussions.
