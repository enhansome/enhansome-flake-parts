...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,450 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Source code and issue tracker.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,450 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,549 | 🐛 98 | 🌐 Nix | 📅 2026-06-18 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 945 | 🐛 21 | 🌐 Nix | 📅 2026-08-25 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 859 | 🐛 91 | 🌐 Nix | 📅 2026-08-22 - Git pre-commit hooks integration.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 608 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
* [import-tree](https://github.com/vic/import-tree) ⭐ 323 | 🐛 1 | 🌐 Nix | 📅 2026-07-17 - Import all nix files in a directory tree.
* [flake-file](https://github.com/vic/flake-file) ⭐ 144 | 🐛 14 | 🌐 Nix | 📅 2026-07-28 - Dynamically generate your flake.nix from flake-parts modules.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 3 | 🌐 Nix | 📅 2026-08-25 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 200 | 🐛 14 | 🌐 Nix | 📅 2026-08-25 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [VTimofeenko/monorepo-machine-config](https://github.com/VTimofeenko/monorepo-machine-config) ⭐ 28 | 🐛 0 | 🌐 Nix | 📅 2026-08-25 - Monorepo containing dotfiles and machine configurations.
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 0 | 🌐 Nix | 📅 2026-08-24 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,450 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Q\&A and discussions.
