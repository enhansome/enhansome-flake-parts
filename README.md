...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,475 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Source code and issue tracker.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,475 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,557 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 955 | 🐛 20 | 🌐 Nix | 📅 2026-09-22 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 867 | 🐛 102 | 🌐 Nix | 📅 2026-09-22 - Git pre-commit hooks integration.
* [services flake](https://github.com/juspay/services-flake) ⭐ 769 | 🐛 56 | 🌐 Nix | 📅 2026-09-24 -  NixOS-like services for Nix as flake modules.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 652 | 🐛 102 | 🌐 Nix | 📅 2026-08-16 - Declarative formatter configuration.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 588 | 🐛 2 | 🌐 Nix | 📅 2026-09-23 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 205 | 🐛 14 | 🌐 Nix | 📅 2026-09-24 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,475 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Q\&A and discussions.
