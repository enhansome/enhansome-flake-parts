...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,473 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Source code and issue tracker.
...
* [Dendritc Design with the Flake Parts Framework](https://github.com/Doc-Steve/dendritic-design-with-flake-parts) ⭐ 450 | 🐛 0 | 🌐 Nix | 📅 2026-01-28 - A guide on how to structure your Nix code with Flake Parts using the Dendritic Pattern.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,473 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,557 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 951 | 🐛 21 | 🌐 Nix | 📅 2026-09-22 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 864 | 🐛 101 | 🌐 Nix | 📅 2026-09-15 - Git pre-commit hooks integration.
* [services flake](https://github.com/juspay/services-flake) ⭐ 768 | 🐛 58 | 🌐 Nix | 📅 2026-09-20 -  NixOS-like services for Nix as flake modules.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 649 | 🐛 99 | 🌐 Nix | 📅 2026-08-16 - Declarative formatter configuration.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 631 | 🐛 1 | 📅 2026-09-04 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
...
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 205 | 🐛 14 | 🌐 Nix | 📅 2026-09-22 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,473 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Q\&A and discussions.
