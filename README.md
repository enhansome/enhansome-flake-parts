...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,447 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Source code and issue tracker.
...
* [Dendritc Design with the Flake Parts Framework](https://github.com/Doc-Steve/dendritic-design-with-flake-parts) ⭐ 434 | 🐛 0 | 🌐 Nix | 📅 2026-01-28 - A guide on how to structure your Nix code with Flake Parts using the Dendritic Pattern.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,447 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,546 | 🐛 97 | 🌐 Nix | 📅 2026-06-18 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 942 | 🐛 22 | 🌐 Nix | 📅 2026-08-16 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 854 | 🐛 90 | 🌐 Nix | 📅 2026-08-11 - Git pre-commit hooks integration.
* [services flake](https://github.com/juspay/services-flake) ⭐ 761 | 🐛 56 | 🌐 Nix | 📅 2026-08-18 -  NixOS-like services for Nix as flake modules.
...
* [community.flake.parts](https://github.com/flake-parts/community.flake.parts) ⭐ 31 | 🐛 6 | 🌐 Nix | 📅 2026-08-15 - A Community website with links to several flake-module projects.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 600 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
* [import-tree](https://github.com/vic/import-tree) ⭐ 318 | 🐛 0 | 🌐 Nix | 📅 2026-07-17 - Import all nix files in a directory tree.
* [flake-file](https://github.com/vic/flake-file) ⭐ 143 | 🐛 13 | 🌐 Nix | 📅 2026-07-28 - Dynamically generate your flake.nix from flake-parts modules.
...
* [Flake-parts Builder](https://github.com/tsandrini/flake-parts-builder) ⭐ 47 | 🐛 14 | 🌐 Rust | 📅 2025-11-24 - Nix flakes interactive template builder based on flake-parts written in Rust.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 586 | 🐛 4 | 🌐 Nix | 📅 2026-08-18 - NixOS configuration with flake-parts.
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 198 | 🐛 14 | 🌐 Nix | 📅 2026-08-18 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
* [dropol/infra](https://github.com/drupol/infra) ⭐ 147 | 🐛 1 | 🌐 Nix | 📅 2026-08-03 - Pol Dellaiera's configuration of all his home computers.
* [vic/vix](https://github.com/vic/vix) ⭐ 94 | 🐛 25 | 🌐 Nix | 📅 2026-04-28 - Vic's \*Nix config with flake-parts and [import-tree](https://github.com/vic/import-tree) ⭐ 318 | 🐛 0 | 🌐 Nix | 📅 2026-07-17.
...
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 0 | 🌐 Nix | 📅 2026-08-16 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,447 | 🐛 78 | 🌐 Nix | 📅 2026-08-01 - Q\&A and discussions.
