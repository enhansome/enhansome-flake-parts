...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,458 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Source code and issue tracker.
...
* [Dendritc Design with the Flake Parts Framework](https://github.com/Doc-Steve/dendritic-design-with-flake-parts) ⭐ 435 | 🐛 0 | 🌐 Nix | 📅 2026-01-28 - A guide on how to structure your Nix code with Flake Parts using the Dendritic Pattern.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,458 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,550 | 🐛 98 | 🌐 Nix | 📅 2026-06-18 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 947 | 🐛 21 | 🌐 Nix | 📅 2026-09-01 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 859 | 🐛 92 | 🌐 Nix | 📅 2026-09-01 - Git pre-commit hooks integration.
* [services flake](https://github.com/juspay/services-flake) ⭐ 765 | 🐛 59 | 🌐 Nix | 📅 2026-08-30 -  NixOS-like services for Nix as flake modules.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 643 | 🐛 94 | 🌐 Nix | 📅 2026-08-16 - Declarative formatter configuration.
...
* [The Dendritic Pattern](https://github.com/mightyiam/dendritic) ⭐ 616 | 🐛 1 | 📅 2026-07-31 - Nix flake-parts usage pattern in which every Nix file is a flake-parts module.
* [import-tree](https://github.com/vic/import-tree) ⭐ 327 | 🐛 2 | 🌐 Nix | 📅 2026-08-31 - Import all nix files in a directory tree.
* [flake-file](https://github.com/vic/flake-file) ⭐ 150 | 🐛 12 | 🌐 Nix | 📅 2026-08-31 - Dynamically generate your flake.nix from flake-parts modules.
...
* [mightyiam/infra](https://github.com/mightyiam/infra) ⭐ 202 | 🐛 14 | 🌐 Nix | 📅 2026-09-01 - Shahar "Dawn" Or (mightyiam)'s personal Nix-powered IT infrastructure repository.
* [dropol/infra](https://github.com/drupol/infra) ⭐ 153 | 🐛 2 | 🌐 Nix | 📅 2026-08-29 - Pol Dellaiera's configuration of all his home computers.
* [vic/vix](https://github.com/vic/vix) ⭐ 95 | 🐛 25 | 🌐 Nix | 📅 2026-04-28 - Vic's \*Nix config with flake-parts and [import-tree](https://github.com/vic/import-tree) ⭐ 327 | 🐛 2 | 🌐 Nix | 📅 2026-08-31.
...
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 0 | 🌐 Nix | 📅 2026-09-01 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,458 | 🐛 76 | 🌐 Nix | 📅 2026-08-24 - Q\&A and discussions.
