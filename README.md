...
* [flake-parts Repository](https://github.com/hercules-ci/flake-parts) ⭐ 1,474 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Source code and issue tracker.
...
* [flake-parts/modules](https://github.com/hercules-ci/flake-parts/tree/master/modules) ⭐ 1,474 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Built-in modules.

### Community Modules

* [devshell](https://github.com/numtide/devshell) ⭐ 1,557 | 🐛 97 | 🌐 Nix | 📅 2026-09-02 - Improved developer shells.
* [nix-gaming](https://github.com/fufexan/nix-gaming) ⭐ 953 | 🐛 21 | 🌐 Nix | 📅 2026-09-22 - Gaming tools and configurations.
* [pre-commit-hooks-nix](https://github.com/cachix/pre-commit-hooks.nix) ⭐ 864 | 🐛 100 | 🌐 Nix | 📅 2026-09-22 - Git pre-commit hooks integration.
* [services flake](https://github.com/juspay/services-flake) ⭐ 769 | 🐛 59 | 🌐 Nix | 📅 2026-09-20 -  NixOS-like services for Nix as flake modules.
* [treefmt-nix](https://github.com/numtide/treefmt-nix) ⭐ 651 | 🐛 100 | 🌐 Nix | 📅 2026-08-16 - Declarative formatter configuration.
...
* [srid/nixos-config](https://github.com/srid/nixos-config) ⭐ 588 | 🐛 3 | 🌐 Nix | 📅 2026-09-23 - NixOS configuration with flake-parts.
...
* [dtomvan/puntbestanden](https://github.com/dtomvan/puntbestanden) ⭐ 15 | 🐛 0 | 🌐 Nix | 📅 2026-09-22 - Tom van Dijk's monolithic, interconnected NixOS/HomeManager/Nixvim configs.
...
* [GitHub Discussions](https://github.com/hercules-ci/flake-parts/discussions) ⭐ 1,474 | 🐛 76 | 🌐 Nix | 📅 2026-09-03 - Q\&A and discussions.
